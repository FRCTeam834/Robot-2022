...
public class InterpolatingTable {
    ...
    private static final TreeMap<Double, ShotParams> table = new TreeMap<>(Map.ofEntries(
    ...
    public static ShotParams getDistance(double distance) {
        ...
        return ceiling.getValue().interpolate(floor.getValue(), (distance-floor.getKey())/(ceiling.getKey()-floor.getKey()));
