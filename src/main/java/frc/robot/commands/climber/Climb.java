...
public class Climb extends SequentialCommandGroup {
  ...
  public Climb() {
    ...
    addCommands(/*
        ...
        // Engage the lifting hooks (will prevent the robot from falling when tilt tubes are retracted)
        new ParallelCommandGroup(
            new MoveTubeToPosition(RobotContainer.climber.leftLift, Parameters.climber.lift.GRAB_DISTANCE),
            new MoveTubeToPosition(RobotContainer.climber.rightLift, Parameters.climber.lift.GRAB_DISTANCE)),

        // Lower the tilt tubes
        new ParallelCommandGroup(
            new MoveTubeToPosition(RobotContainer.climber.leftTilt, Parameters.climber.tilt.DOWN_DISTANCE),
            new MoveTubeToPosition(RobotContainer.climber.rightTilt, Parameters.climber.tilt.DOWN_DISTANCE)),
