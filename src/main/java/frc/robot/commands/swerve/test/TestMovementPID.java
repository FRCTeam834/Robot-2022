...
public class TestMovementPID extends CommandBase {
    ...
    public void initialize() {
        ...
        RobotContainer.driveTrain.resetOdometry(new Pose2d(0, 0, new Rotation2d()));
    }
    ...
    public void execute() {
        ...
        if (RobotContainer.leftJoystick.getRawButton(3)) {
            RobotContainer.driveTrain.trajectoryFollow(
                    new Pose2d(
                            RobotContainer.driveTrain.getXPosition() + 1,
                            RobotContainer.driveTrain.getYPosition(),
                            new Rotation2d()),
                    1);
        }
        ...
        // The left button
            ...
            RobotContainer.driveTrain.trajectoryFollow(
                    new Pose2d(
                            RobotContainer.driveTrain.getXPosition(),
                            RobotContainer.driveTrain.getYPosition() - 1,
                            new Rotation2d()),
                    1);
        }
            ...
            RobotContainer.driveTrain.trajectoryFollow(
                    new Pose2d(
                            ...
                            Rotation2d.fromDegrees(
                                    RobotContainer.driveTrain.getThetaPosition().getDegrees() - 90)),
                    1);
        }
