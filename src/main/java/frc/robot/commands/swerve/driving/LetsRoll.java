...
public class LetsRoll extends CommandBase {
    ...
    public void execute() {
        ...
        if (true) {
            ...
            // leftX =
            // RobotContainer.constrainJoystick(RobotContainer.quadController.getRawAxis(0));
            // rightX =
            // RobotContainer.constrainJoystick(RobotContainer.quadController.getRawAxis(2));
            // rightY =
            // RobotContainer.constrainJoystick(RobotContainer.quadController.getRawAxis(3));
        }
