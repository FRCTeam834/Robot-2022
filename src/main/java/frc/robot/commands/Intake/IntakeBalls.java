...
public class IntakeBalls extends CommandBase {
    ...
    public void execute() {
        ...
        if (RobotContainer.shooter.getBottomSensor()) {
            ...
            // If the if statement that checks if this is true is being evaluated, it means that the
            // sensor will have
            // Changed, that is why it is set to true here even if the sensor hasn't changed at this
            // point
